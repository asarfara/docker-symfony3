#!/bin/bash
- docker tag ali-sarfaraz/docker-test-symfony:latest 550760950390.dkr.ecr.ap-southeast-2.amazonaws.com/ali-sarfaraz/docker-test-symfony:latest
- docker push 550760950390.dkr.ecr.ap-southeast-2.amazonaws.com/ali-sarfaraz/docker-test-symfony:latest
